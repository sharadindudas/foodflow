        ...
        <div className="flex justify-between items-center h-full container mx-auto">
          <div className="flex items-center md:gap-5 gap-2">
            ...
            <button
              ...
              <span className="custom-underline relative font-ProximaNovaBold text-sm group-hover:text-color-2">Other</span>
              {userLocation ? (
              ...
              <div className="relative overflow-hidden font-ProximaNovaSemiBold">
                {cartItems.length > 0 ? (
                  <>
                    ...
                    <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm text-white">{totalQuantity}</span>
                  </>
                ) : (
                  <>
                    <svg
                    ...
                    <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm">{totalQuantity}</span>
                  </>
                )}
              </div>
