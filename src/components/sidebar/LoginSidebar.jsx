...
const LoginSidebar = () => {
  ...
  return (
    <>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-ProximaNovaThin mt-1">
                    and <span className="text-color-2 font-ProximaNovaMed">Enjoy your time</span>
                  </p>
                </div>
                <div>
                  <img
      ...
      <div
        className={`login-sidebar-overlay ${isLoginSidebarOpen ? "fixed" : "hidden"} z-10 top-0 left-0 right-0 bottom-0 bg-color-1 opacity-[0.7] overflow-hidden`}></div>
    </>
  );
};
